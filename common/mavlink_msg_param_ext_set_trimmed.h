...
#define MAVLINK_MSG_ID_PARAM_EXT_SET_TRIMMED_CRC 24
#define MAVLINK_MSG_ID_326_CRC 24
...
#define MAVLINK_MESSAGE_INFO_PARAM_EXT_SET_TRIMMED { \
    ...
    {  { "target_system", NULL, MAVLINK_TYPE_UINT8_T, 0, 0, offsetof(mavlink_param_ext_set_trimmed_t, target_system) }, \
         ...
         { "param_id", NULL, MAVLINK_TYPE_CHAR, 16, 2, offsetof(mavlink_param_ext_set_trimmed_t, param_id) }, \
         { "param_type", NULL, MAVLINK_TYPE_UINT8_T, 0, 18, offsetof(mavlink_param_ext_set_trimmed_t, param_type) }, \
...
{
    return mavlink_msg_param_ext_set_trimmed_pack(system_id, component_id, msg, param_ext_set_trimmed->target_system, param_ext_set_trimmed->target_component, param_ext_set_trimmed->param_id, param_ext_set_trimmed->param_type, param_ext_set_trimmed->param_value);
}
...
{
    return mavlink_msg_param_ext_set_trimmed_pack_chan(system_id, component_id, chan, msg, param_ext_set_trimmed->target_system, param_ext_set_trimmed->target_component, param_ext_set_trimmed->param_id, param_ext_set_trimmed->param_type, param_ext_set_trimmed->param_value);
}
...
static inline void mavlink_msg_param_ext_set_trimmed_send(mavlink_channel_t chan, uint8_t target_system, uint8_t target_component, const char *param_id, uint8_t param_type, const char *param_value)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_PARAM_EXT_SET_TRIMMED_LEN];
    _mav_put_uint8_t(buf, 0, target_system);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_param_ext_set_trimmed_send(chan, param_ext_set_trimmed->target_system, param_ext_set_trimmed->target_component, param_ext_set_trimmed->param_id, param_ext_set_trimmed->param_type, param_ext_set_trimmed->param_value);
#else
 ...
 */
static inline void mavlink_msg_param_ext_set_trimmed_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint8_t target_system, uint8_t target_component, const char *param_id, uint8_t param_type, const char *param_value)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
