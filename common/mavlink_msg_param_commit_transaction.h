...
#define MAVLINK_MSG_ID_PARAM_COMMIT_TRANSACTION_LEN 6
#define MAVLINK_MSG_ID_PARAM_COMMIT_TRANSACTION_MIN_LEN 6
#define MAVLINK_MSG_ID_329_LEN 6
#define MAVLINK_MSG_ID_329_MIN_LEN 6

#define MAVLINK_MSG_ID_PARAM_COMMIT_TRANSACTION_CRC 121
#define MAVLINK_MSG_ID_329_CRC 121
...
#define MAVLINK_MESSAGE_INFO_PARAM_COMMIT_TRANSACTION { \
    ...
    5, \
    {  { "target_system", NULL, MAVLINK_TYPE_UINT8_T, 0, 2, offsetof(mavlink_param_commit_transaction_t, target_system) }, \
         { "target_component", NULL, MAVLINK_TYPE_UINT8_T, 0, 3, offsetof(mavlink_param_commit_transaction_t, target_component) }, \
         { "param_action", NULL, MAVLINK_TYPE_UINT8_T, 0, 4, offsetof(mavlink_param_commit_transaction_t, param_action) }, \
         { "transaction_id", NULL, MAVLINK_TYPE_UINT16_T, 0, 0, offsetof(mavlink_param_commit_transaction_t, transaction_id) }, \
         { "response", NULL, MAVLINK_TYPE_UINT8_T, 0, 5, offsetof(mavlink_param_commit_transaction_t, response) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_PARAM_COMMIT_TRANSACTION { \
 ...
 * @param param_action  Commit or cancel an ongoing transaction.
...
static inline uint16_t mavlink_msg_param_commit_transaction_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               uint8_t target_system, uint8_t target_component, uint8_t param_action, uint16_t transaction_id, uint8_t response)
{
    ...
    _mav_put_uint8_t(buf, 4, param_action);
...
{
    return mavlink_msg_param_commit_transaction_pack(system_id, component_id, msg, param_commit_transaction->target_system, param_commit_transaction->target_component, param_commit_transaction->param_action, param_commit_transaction->transaction_id, param_commit_transaction->response);
}
...
{
    return mavlink_msg_param_commit_transaction_pack_chan(system_id, component_id, chan, msg, param_commit_transaction->target_system, param_commit_transaction->target_component, param_commit_transaction->param_action, param_commit_transaction->transaction_id, param_commit_transaction->response);
}
...
static inline void mavlink_msg_param_commit_transaction_send(mavlink_channel_t chan, uint8_t target_system, uint8_t target_component, uint8_t param_action, uint16_t transaction_id, uint8_t response)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_PARAM_COMMIT_TRANSACTION_LEN];
    _mav_put_uint16_t(buf, 0, transaction_id);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_param_commit_transaction_send(chan, param_commit_transaction->target_system, param_commit_transaction->target_component, param_commit_transaction->param_action, param_commit_transaction->transaction_id, param_commit_transaction->response);
#else
 ...
 */
static inline void mavlink_msg_param_commit_transaction_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint8_t target_system, uint8_t target_component, uint8_t param_action, uint16_t transaction_id, uint8_t response)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
/**
 * @brief Get field param_action from param_commit_transaction message
 *
 * @return  Commit or cancel an ongoing transaction.
 */
static inline uint8_t mavlink_msg_param_commit_transaction_get_param_action(const mavlink_message_t* msg)
{
    return _MAV_RETURN_uint8_t(msg,  4);
}

/**
 * @brief Get field transaction_id from param_commit_transaction message
 *
 * @return  Identifier for a specific transaction.
 */
static inline uint16_t mavlink_msg_param_commit_transaction_get_transaction_id(const mavlink_message_t* msg)
{
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    param_commit_transaction->transaction_id = mavlink_msg_param_commit_transaction_get_transaction_id(msg);
    ...
    param_commit_transaction->param_action = mavlink_msg_param_commit_transaction_get_param_action(msg);
