...
#define MAVLINK_MSG_ID_PARAM_EXT_VALUE_TRIMMED_CRC 228
#define MAVLINK_MSG_ID_325_CRC 228
...
#define MAVLINK_MESSAGE_INFO_PARAM_EXT_VALUE_TRIMMED { \
    ...
    5, \
    {  { "param_id", NULL, MAVLINK_TYPE_CHAR, 16, 4, offsetof(mavlink_param_ext_value_trimmed_t, param_id) }, \
         { "param_type", NULL, MAVLINK_TYPE_UINT8_T, 0, 20, offsetof(mavlink_param_ext_value_trimmed_t, param_type) }, \
...
{
    return mavlink_msg_param_ext_value_trimmed_pack(system_id, component_id, msg, param_ext_value_trimmed->param_id, param_ext_value_trimmed->param_type, param_ext_value_trimmed->param_count, param_ext_value_trimmed->param_index, param_ext_value_trimmed->param_value);
}
...
{
    return mavlink_msg_param_ext_value_trimmed_pack_chan(system_id, component_id, chan, msg, param_ext_value_trimmed->param_id, param_ext_value_trimmed->param_type, param_ext_value_trimmed->param_count, param_ext_value_trimmed->param_index, param_ext_value_trimmed->param_value);
}
...
static inline void mavlink_msg_param_ext_value_trimmed_send(mavlink_channel_t chan, const char *param_id, uint8_t param_type, uint16_t param_count, uint16_t param_index, const char *param_value)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_PARAM_EXT_VALUE_TRIMMED_LEN];
    _mav_put_uint16_t(buf, 0, param_count);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_param_ext_value_trimmed_send(chan, param_ext_value_trimmed->param_id, param_ext_value_trimmed->param_type, param_ext_value_trimmed->param_count, param_ext_value_trimmed->param_index, param_ext_value_trimmed->param_value);
#else
 ...
 */
static inline void mavlink_msg_param_ext_value_trimmed_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  const char *param_id, uint8_t param_type, uint16_t param_count, uint16_t param_index, const char *param_value)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
