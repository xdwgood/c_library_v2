...
#define MAVLINK_MSG_ID_PARAM_EXT_ACK_TRIMMED_CRC 178
#define MAVLINK_MSG_ID_327_CRC 178
...
#define MAVLINK_MESSAGE_INFO_PARAM_EXT_ACK_TRIMMED { \
    ...
    4, \
    {  { "param_id", NULL, MAVLINK_TYPE_CHAR, 16, 0, offsetof(mavlink_param_ext_ack_trimmed_t, param_id) }, \
         { "param_type", NULL, MAVLINK_TYPE_UINT8_T, 0, 16, offsetof(mavlink_param_ext_ack_trimmed_t, param_type) }, \
         { "param_result", NULL, MAVLINK_TYPE_UINT8_T, 0, 17, offsetof(mavlink_param_ext_ack_trimmed_t, param_result) }, \
...
{
    return mavlink_msg_param_ext_ack_trimmed_pack(system_id, component_id, msg, param_ext_ack_trimmed->param_id, param_ext_ack_trimmed->param_type, param_ext_ack_trimmed->param_result, param_ext_ack_trimmed->param_value);
}
...
{
    return mavlink_msg_param_ext_ack_trimmed_pack_chan(system_id, component_id, chan, msg, param_ext_ack_trimmed->param_id, param_ext_ack_trimmed->param_type, param_ext_ack_trimmed->param_result, param_ext_ack_trimmed->param_value);
}
...
static inline void mavlink_msg_param_ext_ack_trimmed_send(mavlink_channel_t chan, const char *param_id, uint8_t param_type, uint8_t param_result, const char *param_value)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_PARAM_EXT_ACK_TRIMMED_LEN];
    _mav_put_uint8_t(buf, 16, param_type);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_param_ext_ack_trimmed_send(chan, param_ext_ack_trimmed->param_id, param_ext_ack_trimmed->param_type, param_ext_ack_trimmed->param_result, param_ext_ack_trimmed->param_value);
#else
 ...
 */
static inline void mavlink_msg_param_ext_ack_trimmed_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  const char *param_id, uint8_t param_type, uint8_t param_result, const char *param_value)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
